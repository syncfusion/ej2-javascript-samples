...
var items = new ej.data.DataManager(dataSource, new ej.data.Query().take(7));
function setNodeTemplate(node, diagram) {
...
this.default = function () {
    ...
    setNodeTemplate: function (node, diagram) {
    return setNodeTemplate(node, diagram);
    }
});
