...
this.default = function () {
    ...
    var portVisibilityDrop = new ej.dropdowns.MultiSelect({
    ...
    var portFillDrop = new ej.inputs.ColorPicker({
    ...
    var portBorderDrop = new ej.inputs.ColorPicker({
        value: '#000', disabled: false, change: function (arg) {
            var port = getPort();
            for (var j = 0; j < port.length; j++) {
    ...
    var portShapeDrop = new ej.dropdowns.DropDownList({
    ...
    var portSizeNum = new ej.inputs.NumericTextBox({
        enabled: true,
        format: '###.##',
        value: 6,
        min: 1,
    ...
    var portWidthNum = new ej.inputs.NumericTextBox({
        enabled: true,
        format: '###.##',
        value: 1,
        min: 0.5,
