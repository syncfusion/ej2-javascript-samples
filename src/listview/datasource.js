window.newsData = [
        ...
        },
        {
            ...
            'content': '<p>The following is a short interview with Succinctly series author Stan Drapkin, whose latest book' +
                 ...
                 'focused enough on how to use these tools to engineer secure systems.</p><p>How will application security change over the next few years?</p><p>I think' +
        ...
        },
        {
            ...
            'content': '<p>This guest blog post was written by Dave Lasike. He can be found on Twitter at' +
                 ...
                 'data grid being rendered to the second page in the PDF document.</p>'
        },
        {
            ...
            'content': '<p>On October 17, Microsoft will release its Fall Creators Update for the Windows 10 platform. Much like' +
             ...
             'viewer int`eractivity rarely found in other streaming services. It’s not only a streaming service, but also a' +
