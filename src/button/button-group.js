...
this.default = function() {
    var buttonElement = new ej.buttons.Button({iconCss: 'e-icons e-btngrp-watch'});
    buttonElement.appendTo('#watch');

    buttonElement = new ej.buttons.Button({iconCss: 'e-icons e-btngrp-star'});
    buttonElement.appendTo('#star');

    buttonElement = new ej.buttons.Button({iconCss: 'e-icons e-btngrp-download'});
