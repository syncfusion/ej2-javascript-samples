...
window.generateObject = function() {
    var data = [];
    var names = [
        ...
        'Endangered Species Program', 'Black Cockatoos Playtime', 'Walk with Jungle King', 'Trained Climers', 'Playtime with Chimpanzees',
        'Meet a small Mammal', 'Amazon Fish Feeding', 'Elephant Ride'
    ];
    var start = new Date(2017, 6, 1).getTime();
    var end = new Date(2018, 6, 31).getTime();
